...
$idcat = (isset($_GET['id_post']) && $_GET['id_post'] != '') ? (int)$_GET['id_post'] : 0;
$start = ($p - 1) * $pagingAjax->perpage;
$pageLink = "ajax/ajax_product_paging.php?idl=" . $idl . "&id=" . $id . "&id_post=" . $idcat . "&perpage=" . $pagingAjax->perpage;
$tempLink = "";
$where = "";
...
$sp_thaythe = $cache->getCache($sqlCache, 'result', 7200);
// var_dump($sqlCache);
