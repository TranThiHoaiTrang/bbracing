...
<div id="gallery" style="display:none;">
    ...
    <a href="<?=$config_base?>">
        <img alt="<?=$row_detail['ten'.$lang]?>" src="<?=THUMBS?>/0x350x1/<?=UPLOAD_NEWS_L.$v['photo']?>"
            data-image="<?=UPLOAD_NEWS_L.$v['photo']?>" data-description="<?=$v['tenvi']?>" style="display:none">
    </a>
    <?php }?>
</div>
<?php }?>
...
<div class="loadkhung_product">
    ...
    <div class="boxproduct_item">
        <a class="boxproduct_img" href="<?=$v['tenkhongdauvi']?>"><span><img
                    ...
                    src="<?=THUMBS?>/380x270x2/<?=UPLOAD_NEWS_L.$v['photo']?>" alt="<?=$v['ten'.$lang]?>" /></span></a>
