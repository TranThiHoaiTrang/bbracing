                        ...
                        <div class="all_hide_fillter">
                            ...
                            <div class="all_fillter_danhmuc">
                                    ...
                                    <div class="all_brand_sp">
                                        ...
                                        <div class="danhmuc_tong">
                                            <ul class="all_danhmuc_con all_danhmuc_con_scroll">
                                                ...
                                                foreach ($splistmenu_order as $b) { ?>
                                                    <?php if (!empty($arr_idlist)) { ?>
                                                        <li class="check_idlist check_idlist_dm <?= in_array($b['id'], $arr_idlist) ? 'active' : '' ?>" data-idlist="<?= $b['id'] ?>">
                                                        <?php } else { ?>
                                                        <li class="check_idlist check_idlist_dm <?= $b['id'] == $idl ? 'active' : '' ?>" data-idlist="<?= $b['id'] ?>">
                                                        <?php } ?>
                                            ...
                                            <ul class="all_danhmuc_con all_danhmuc_con_scroll all_danhmuc_con_catalog">
                                                ...
                                                if ($lang == 'vi') {
                                                    if ($_REQUEST['id_list']) {
                                                        ...
                                                        $spbrandmenu_catalog = $d->rawQuery("select * from #_product_brand where type = 'san-pham' and id_list REGEXP '" . $arr_idlist . "' and hienthi > 0 order by tenvi ASC");
                                                    } elseif (!empty($idl)) {
                                                        $spbrandmenu_catalog = $d->rawQuery("select * from #_product_brand where type = 'san-pham' and id_list REGEXP '" . $idl . "' and hienthi > 0 order by tenvi ASC");
                                                    } else {
                                                        $spbrandmenu_catalog = $d->rawQuery("select * from #_product_brand where type = 'san-pham' and hienthi > 0 order by tenvi ASC");
                                                    }
                                                } else {
                                                    if ($_REQUEST['id_list']) {
                                                        $arr_idlist = explode("-", $_REQUEST['id_list']);
                                                        $arr_idlist = implode("|", $arr_idlist);
                                                        $spbrandmenu_catalog = $d->rawQuery("select * from #_product_brand where type = 'san-pham' and id_list REGEXP '" . $arr_idlist . "' and hienthi > 0 order by tenen ASC");
                                                    } elseif (!empty($idl)) {
                                                        $spbrandmenu_catalog = $d->rawQuery("select * from #_product_brand where type = 'san-pham' and id_list REGEXP '" . $idl . "' and hienthi > 0 order by tenen ASC");
                                                    } else {
                                                        $spbrandmenu_catalog = $d->rawQuery("select * from #_product_brand where type = 'san-pham' and hienthi > 0 order by tenen ASC");
                                                    }
                                                }
                                                ...
                                                foreach ($spbrandmenu_catalog as $b) { ?>
                                                    <li class="check_brand <?= in_array($b['id'], $arr_idbrand) ? 'active' : '' ?>" data-idbrand="<?= $b['id'] ?>">
                                                        <div class="icon_check_brand" style="z-index: -1;">
                                                            <i class="<?= in_array($b['id'], $arr_idbrand) ? 'far fa-check-square' : 'far fa-square' ?>"></i>
                                                        </div>
                                                        <span><?= $b['ten' . $lang] ?></span>
                                                    </li>
                                                <?php } ?>
                                ...
                                <?php } elseif (!empty($idd)) { ?>
                                    ...
                                    ?>
                                        <div class="all_brand_sp">
                                            <?php if (!empty($arr_iddoday)) { ?>
                                                <div class="title_brand <?= in_array($b['id'], $arr_iddoday) ? 'active' : '' ?> ">
                                                <?php } else { ?>
                                                    <div class="title_brand <?= $idd == $b['id'] ? '' : 'active' ?>">
                                                    <?php } ?>
                                                    <?php if (!empty($arr_iddoday)) { ?>
                                                        <div class="check_vehicles  <?= in_array($b['id'], $arr_iddoday) ? 'active' : '' ?>" data-idvehicles="<?= $b['id'] ?>">
                                                        <?php } else { ?>
                                                            <div class="check_vehicles <?= $idd == $b['id'] ? 'active' : '' ?>" data-idvehicles="<?= $b['id'] ?>">
                                                            <?php } ?>
                                                            <div class="icon_check_brand" style="z-index: -1;">
                                                                <?php if (!empty($arr_iddoday)) { ?>
                                                                    <?php if (in_array($b['id'], $arr_iddoday)) { ?>
                                                                        <i class="far fa-check-square"></i>
                                                                    <?php } else { ?>
                                                                        <i class="far fa-square"></i>
                                                                    <?php } ?>
                                                        ...
                                                        <?php if (!empty($arr_iddoday)) { ?>
                                                            <div class="danhmuc_tong_vh " style="display: <?= in_array($b['id'], $arr_iddoday) ? '' : 'none' ?>;">
                                                            <?php } else { ?>
                                                                <div class="danhmuc_tong_vh " style="display: <?= $idd == $b['id'] ? '' : 'none' ?>;">
                                                                <?php } ?>
                                                    ...
                                                    <?php } elseif (!empty($iddl)) { ?>
                                                        <?php foreach ($thuonghieuxe_order as $b) {
                                                            ...
                                                            // $brand_xe_l = $d->rawQuery("select * from #_product_doday_list where type = ? and id_doday = ? order by stt,id desc", array('san-pham', $b['id']));
                                                            $arr_brand_xe_l_id = [];
                                                            foreach ($brand_xe_l as $br_l) {
                                                                $arr_brand_xe_l_id[] = $br_l['id'];
                                                            }
                                                        ?>
                                                            <div class="all_brand_sp">
                                                                <div class="title_brand <?= in_array($iddl, $arr_brand_xe_l_id) ? '' : 'active' ?>">
                                                                    <div class="check_vehicles <?= in_array($iddl, $arr_brand_xe_l_id) ? 'active' : '' ?>" data-idvehicles="<?= $b['id'] ?>">
                                                                        <div class="icon_check_brand" style="z-index: -1;">
                                                                            <?php if (in_array($iddl, $arr_brand_xe_l_id)) { ?>
                                                                                <i class="far fa-check-square"></i>
                                                                            <?php } else { ?>
                                                                                <i class="far fa-square"></i>
                                                                            <?php } ?>
                                                                ...
                                                                <div class="danhmuc_tong" style="display: <?= in_array($iddl, $arr_brand_xe_l_id) ? '' : 'none' ?>;">
                                                                    <ul class="all_danhmuc_con all_danhmuc_con_vhc_scroll">
                                                                        <?php foreach ($brand_xe_l as $b) { ?>
                                                                            <li class="all_danhmuc_con_vehicles <?= $b['id'] != $iddl ? '' : 'active' ?>">
                                                                                <a href="<?= $b['tenkhongdauvi'] ?>"><?= $b['ten' . $lang] ?></a>
                                                                            </li>
                                                                        <?php } ?>
                                                                    </ul>
