                                ...
                                <div class="all_brand_sp">
                                    ...
                                    <div class="danhmuc_tong">
                                        <ul class="all_danhmuc_con all_danhmuc_con_scroll all_danhmuc_con_catalog">
                                            <?php
                                            if (!empty($idl)) {
                                                $spbrandmenu_catalog = $d->rawQuery("select * from #_product_brand where type = 'san-pham' and id_list REGEXP '" . $idl . "' and hienthi > 0 order by stt,id desc");
                                            } elseif ($_REQUEST['id_list']) {
                                                $spbrandmenu_catalog = $d->rawQuery("select * from #_product_brand where type = 'san-pham' and id_list REGEXP '" . $_REQUEST['id_list'] . "' and hienthi > 0 order by stt,id desc");
                                            } else {
                                                $spbrandmenu_catalog = $d->rawQuery("select * from #_product_brand where type = 'san-pham' and hienthi > 0 order by stt,id desc");
                                            }
                            ...
                            <?php } elseif (!empty($idd)) { ?>
                                ...
                                ?>
                                    <div class="all_brand_sp">
                                        ...
                                        <div class="danhmuc_tong " style="display: <?= $idd == $b['id'] ? '' : 'none' ?>;">
                                    ...
                                    <div class="danhmuc_tong">
                                        <ul class="all_danhmuc_con all_danhmuc_con_scroll">
                                            <?php foreach ($brand as $b) { ?>
                                                <li class="check_brand check_brand_dm <?= $b['id'] == $idb ? 'active' : '' ?> " data-idbrand="<?= $b['id'] ?>">
                                                    <div class="icon_check_brand">
                                                        <?php if ($b['id'] == $idb) { ?>
                                                            <i class="far fa-check-square"></i>
                                                        <?php } elseif ($b['id'] == $_REQUEST['id_brand']) { ?>
                                                            <i class="far fa-check-square"></i>
                                                        <?php } else { ?>
                                                            <i class="far fa-square"></i>
                                                        <?php } ?>
                                ...
                                <div class="all_brand_sp">
                                    ...
                                    <div class="danhmuc_tong">
                                        <ul class="all_danhmuc_con all_danhmuc_con_scroll all_danhmuc_con_catalog">
                                            <?php
                                            if (!empty($idb)) {
                                                $splistmenu_brand = $d->rawQuery("select * from #_product_list where type = 'san-pham' and id_brand REGEXP '" . $idb . "' and hienthi > 0 order by stt,id desc");
                                            } elseif ($_REQUEST['id_brand']) {
                                                $splistmenu_brand = $d->rawQuery("select * from #_product_list where type = 'san-pham' and id_brand REGEXP '" . $_REQUEST['id_brand'] . "' and hienthi > 0 order by stt,id desc");
                                            } else {
                                                $splistmenu_brand = $d->rawQuery("select * from #_product_list where type = 'san-pham' and hienthi > 0 order by stt,id desc");
                                            }
                                            ...
                                            foreach ($splistmenu_brand as $b) { ?>
                                                <li class="check_idlist" data-idlist="<?= $b['id'] ?>">
                                                    <div class="icon_check_brand">
                                                        <?php if ($b['id'] == $idl) { ?>
                                                            <i class="far fa-check-square"></i>
                                                        <?php } elseif ($b['id'] == $_REQUEST['id_list']) { ?>
                                                            <i class="far fa-check-square"></i>
                                                        <?php } else { ?>
                                                            <i class="far fa-square"></i>
                                                        <?php } ?>
                                                ...
                                                <div class="all_brand_sp">
                                                    ...
                                                    <div class="danhmuc_tong">
                                                        <ul class="all_danhmuc_con all_danhmuc_con_scroll">
                                                            ...
                                                            if(!empty($ibd)){
                                                                $splistmenu_brand = $d->rawQuery("select * from #_product_list where type = 'san-pham' and id_brand REGEXP '" . $idb . "' and hienthi > 0 order by stt,id desc");
                                                            }elseif(!empty($_REQUEST['id_brand'])){
                                                                $splistmenu_brand = $d->rawQuery("select * from #_product_list where type = 'san-pham' and id_brand REGEXP '" . $_REQUEST['id_brand'] . "' and hienthi > 0 order by stt,id desc");
                                                            }else{
                                                                $splistmenu_brand = $d->rawQuery("select * from #_product_list where type = 'san-pham' and hienthi > 0 order by stt,id desc");
                                                            }
                                                            foreach ($splistmenu_brand as $b) {
                                                                $id_brand_sp = explode(',', $b['id_brand']);
                                                            ?>
                                                                <li class="check_idlist" data-idlist="<?= $b['id'] ?>">
                                                                    <div class="icon_check_brand">
                                                                        <?php if ($b['id'] == $idb) { ?>
