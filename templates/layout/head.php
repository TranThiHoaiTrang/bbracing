...
<!-- Favicon -->
<link href="<?= THUMBS ?>/50x50x2/<?= UPLOAD_PHOTO_L . $favicon['photo'] ?>" rel="shortcut icon" type="image/x-icon" />
...
<!-- Zalo -->
<meta name="zalo:card" content="summary_large_image" />
<meta name="zalo:site" content="<?= $optsetting['email'] ?>" />
<meta name="zalo:creator" content="<?= $setting['ten' . $lang] ?>" />
<meta property="og:url" content="<?= $seo->getSeo('url') ?>" />
<meta property="og:title" content="<?= $seo->getSeo('title') ?>" />
<meta property="og:description" content="<?= $seo->getSeo('description') ?>" />
<meta property="og:image" content="<?= $seo->getSeo('photo') ?>" />
