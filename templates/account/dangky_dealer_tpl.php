    ...
    <?php if ($er == true) { ?>
        <div class="wrap-user wrap_dk">
            <div class="title-user">
                <span><?= $lang == 'vi' ? 'Tạo tài khoản đại lý' : 'Create Account For Dealer' ?></span>
            </div>
            <form class="form-user validation-user" novalidate method="post" action="account/dai-ly" enctype="multipart/form-data">
