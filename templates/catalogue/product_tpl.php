                    ...
                    <div class="all_sp_search">
                        <div class="load_product mainkhung_product ">
                            <?php foreach ($product as $k => $v) {
                                ...
                                $khuyenmai_sanpham_one = $d->rawQueryOne("select discount,icon,photo from #_news where type = 'khuyenmai' and id = '" . $v['id_khuyenmai'] . "' and hienthi > 0 order by stt,id desc limit 1");
