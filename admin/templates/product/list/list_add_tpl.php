                        ...
                        <div class="card-body">
                            <div class="form-group-category row">
                                <div class="form-group col-xl-6 col-sm-6">
                                    <label class="d-block" for="id_news_km">Khuyến mãi:</label>
                                    <?= $func->get_ajax_news_km(@$item['id']) ?>
                                </div>
                                <?php if (isset($config['product'][$type]['brand']) && $config['product'][$type]['brand'] == true) { ?>
                                    <div class="form-group col-xl-6 col-sm-6">
                                        <label class="d-block" for="id_brand">Brand:</label>
                                        <?= $func->get_ajax_category_list(@$item['id']) ?>
                                    </div>
                                <?php } ?>
                            </div>
                            <div class="form-group col-xl-6 col-sm-6">
                                <label class="d-block" for="id_news_km">Danh mục:</label>
                                <?= $func->get_ajax_danhmuc(@$item['id']) ?>
                            </div>
                        </div>
                    </div>
