...
foreach ($quyen_all as $a) {
    if ($a['quyen'] === 'product_add_list_' . $type . '') {
        $none_add = "";
        // break;
    } elseif ($a['quyen'] === 'product_edit_list_' . $type . '') {
        $none_edit = "";
        // break;
    } elseif ($a['quyen'] === 'product_delete_list_' . $type . '') {
        $none_delete = "";
        // break;
    }
}
...
<section class="content">
    ...
    <div class="card card-primary card-outline text-sm mb-0">
        <div class="card-header d-flex justify-content-center align-items-center">
            <h3 class="card-title" style="width: 90%;">Danh sách <?= $config['product'][$type]['title_main_list'] ?></h3>
        ...
        <div class="card-body table-responsive p-0">
            ...
            <input type="hidden" name="table" id="table_nhomdanhmuc" value="product_list">
                    ...
                    <tbody id="the-list">
                        <?php for ($i = 0; $i < count($items); $i++) { ?>
                            <tr id="post-<?= $items[$i]['id'] ?>">
                                ...
                                <td class="align-middle">
                                    <input type="number" class="form-control form-control-mini m-auto update-stt" min="0" value="<?= $items[$i]['stt'] ?>" data-id="<?= $items[$i]['id'] ?>" data-table="product_list" readonly>
                                </td>
                                <?php if (isset($config['product'][$type]['show_images_list']) && $config['product'][$type]['show_images_list'] == true) { ?>
                                    <td class="align-middle">
