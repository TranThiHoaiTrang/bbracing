...
$none_add = "d-none";$none_edit = "d-none";$none_delete = "d-none";

foreach($quyen_all as $a){
    if($a['quyen'] === 'product_add_size_'.$type.''){ 
        $none_add = "";
        // break;
    }
    elseif($a['quyen'] === 'product_edit_size_'.$type.''){ 
        $none_edit = "";
        // break;
    }
    elseif($a['quyen'] === 'product_delete_size_'.$type.'' ){
        $none_delete = "";
        // break;
    }
}
    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Quản lý Tên xe <?=$config['product'][$type]['title_main']?></li>
            </ol>
        </div>
    </div>
</section>
...
<section class="content">
    ...
    <div class="card card-primary card-outline text-sm mb-0">
        <div class="card-header">
            <h3 class="card-title">Danh sách Tên xe <?=$config['product'][$type]['title_main']?></h3>
        </div>
