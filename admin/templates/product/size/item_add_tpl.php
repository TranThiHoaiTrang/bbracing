...
function get_doday($id = 0)
{
    ...
    if ($id) {
        $temps = $d->rawQueryOne("select id_doday from #_product_size where id = ? and type = ? limit 0,1", array($id, $type));
    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Chi tiết Tên xe <?= $config['product'][$type]['title_main'] ?></li>
            </ol>
        </div>
    </div>
</section>
    ...
    <form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="card card-primary card-outline text-sm">
            <div class="card-header">
                <h3 class="card-title"><?= ($act == "edit_size") ? "Cập nhật" : "Thêm mới"; ?> Tên xe <?= $config['product'][$type]['title_main'] ?></h3>
            </div>
            <div class="card-body">
