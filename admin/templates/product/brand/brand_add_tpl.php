        ...
        <div class="row">
            ...
            <div class="<?= $colRight ?>">
                <div id="scroll-right">
                            ...
                            <div class="form-group-category row">
                                <?php if (isset($config['product'][$type]['list']) && $config['product'][$type]['list'] == true) { ?>
                                    <div class="form-group col-xl-6 col-sm-6">
                                        ...
                                        <?= $func->get_ajax_category_brand(@$item['id']) ?>
                                    </div>
                                <?php } ?>
                    ...
                    <?php } ?>
                    <?php if (isset($config['product'][$type]['icon_brand']) && $config['product'][$type]['icon_brand'] == true) { ?>
                        <div class="card card-primary card-outline text-sm">
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                ...
                                $dimension = "Width: " . $config['product'][$type]['width_icon_brand'] . " px - Height: " . $config['product'][$type]['height_icon_brand'] . " px (" . $config['product'][$type]['img_type_brand'] . ")";
