        ...
        <nav class="mt-3">
            <ul data-accordion="true" class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <ul class="nav nav-treeview">
                                <?php if (isset($value['product'])) {
                                    foreach ($value['product'] as $k) {
                                        ...
                                        $v = $config['product'][$k];
                                ?>
                                        <?php if (isset($v['nhomdanhmuc']) && $v['nhomdanhmuc'] == true) {
                                            $none = "";
                                            $active = "";
                                            if (isset($kiemtra) && $kiemtra == true) if ($func->check_access('product', 'man_list', $k, null, 'phrase-1')) $none = "d-none";
                                            if ($com == 'product' && ($act == 'man_nhomdanhmuc' || $act == 'add_nhomdanhmuc' || $act == 'edit_nhomdanhmuc' || $kind == 'man_nhomdanhmuc') && $k == $_GET['type']) $active = "active"; ?>
                                            <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_nhomdanhmuc&type=<?= $k ?>" title="Nhóm danh mục cấp 1"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                    <p>Nhóm danh mục cấp 1</p>
                                                </a></li>
                                        <?php } ?>
                                        ...
                                        <?php if (isset($v['size']) && $v['size'] == true) {
                                            ...
                                            <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_size&type=<?= $k ?>" title="Tên xe"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                    <p>Tên xe</p>
                                                </a></li>
                                        <?php } ?>
                                        ...
                                        <?php if (isset($v['doday']) && $v['doday'] == true) {
                                            ...
                                            <li class="nav-item "><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_doday&type=<?= $k ?>" title="Danh mục Vehicles"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                    <p>Vehicles</p>
                                                </a></li>
                                        <?php } ?>
                            ...
                            <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <?php if (isset($v['size']) && $v['size'] == true) {
                                        ...
                                        if (isset($kiemtra) && $kiemtra == true) if ($func->check_access('product', 'man_size', $k, null, 'phrase-1')) $none = "d-none";
                                        if ($com == 'product' && ($act == 'man_size' || $act == 'add_size' || $act == 'edit_size') && $k == $_GET['type']) $active = "active"; ?>
                                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_size&type=<?= $k ?>" title="Danh mục Tên xe"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                <p>Tên xe</p>
                                            </a></li>
                                    <?php } ?>
                                ...
                                <ul class="nav nav-treeview">
                                    <?php if (isset($v['doday']) && $v['doday'] == true) {
                                        ...
                                        if ($com == 'product' && ($act == 'man_doday' || $act == 'add_doday' || $act == 'edit_doday') && $k == $_GET['type']) $active = "active"; ?>
                                        <li class="nav-item <?= $none ?>">
                                            <a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_doday&type=<?= $k ?>" title="Danh mục Vehicles"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                <p>Vehicles</p>
                                            </a>
                                        </li>
                                    <?php } ?>
                                    <?php if (isset($v['doday_list']) && $v['doday_list'] == true) {
                                        $none = "";
                                        $active = "";
                                        if (isset($kiemtra) && $kiemtra == true) if ($func->check_access('product', 'man_doday_list', $k, null, 'phrase-1')) $none = "d-none";
                                        if ($com == 'product' && ($act == 'man_doday_list' || $act == 'add_doday_list' || $act == 'edit_doday_list') && $k == $_GET['type']) $active = "active"; ?>
                                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_doday_list&type=<?= $k ?>" title="Danh mục Vehicles List"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                <p>Vehicles List</p>
                                            </a></li>
                                    <?php } ?>
                                </ul>

                                <a class="nav-link <?= $active ?>" href="#" title="Quản lý Option">
                                    <i class="nav-icon text-sm fas fa-boxes"></i>
                                    <p>
                                        Quản lý Option
                                        <i class="right fas fa-angle-left"></i>
                                ...
                                <ul class="nav nav-treeview">
                                    <?php if (isset($v['option']) && $v['option'] == true) {
                                        $none = "";
                                        $active = "";
                                        if (isset($kiemtra) && $kiemtra == true) if ($func->check_access('product', 'man_option', $k, null, 'phrase-1')) $none = "d-none";
                                        if ($com == 'product' && ($act == 'man_option' || $act == 'add_option' || $act == 'edit_option') && $k == $_GET['type']) $active = "active"; ?>
                                        <li class="nav-item <?= $none ?>">
                                            <a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_option&type=<?= $k ?>" title="Danh mục Option"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                <p>Option</p>
                                            </a>
                                        </li>
                                    <?php } ?>
                                    <?php if (isset($v['option_list']) && $v['option_list'] == true) {
                                        $none = "";
                                        $active = "";
                                        if (isset($kiemtra) && $kiemtra == true) if ($func->check_access('product', 'man_option_list', $k, null, 'phrase-1')) $none = "d-none";
                                        if ($com == 'product' && ($act == 'man_option_list' || $act == 'add_option_list' || $act == 'edit_option_list') && $k == $_GET['type']) $active = "active"; ?>
                                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_option_list&type=<?= $k ?>" title="Danh mục Option List"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                <p>Option List</p>
                                            </a></li>
                                    <?php } ?>
                                </ul>
                ...
                <?php if (isset($config['newsletter'])) { ?>
                    ...
                    ?>
                    <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                        <a class="nav-link <?= $active ?>" href="#" title="Quản lý bình luận">
                ...
                <?php } ?>
                <!-- Redirect -->
                <!-- </?php if(isset($config['redirect'])) { ?> -->
                <?php
                $none = "";
                $active = "";
                $menuopen = "";
                if (isset($kiemtra) && $kiemtra == true) if ($func->check_access('redirect', 'man', '', null, 'phrase-2')) $none = "d-none";
                if ($com == 'redirect') {
                    $active = 'active';
                    $menuopen = 'menu-open';
                }
                //   var_dump($func->check_access('redirect', 'man', '', null, 'phrase-2'));
                ?>
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    <a class="nav-link <?= $active ?>" href="#" title="Quản lý redirect">
                        <i class="nav-icon text-sm fas fa-tags"></i>
                        <p>
                            Quản lý redirect
                            <i class="right fas fa-angle-left"></i>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        // $none = "";
                        $active = "";
                        // if(isset($kiemtra) && $kiemtra == true) if($func->check_access('redirect', 'man', $k, null, 'phrase-1')) $none = "d-none";
                        if ($com == 'redirect' && 'redirect' == $_GET['type']) $active = "active";
                        ?>
                        <li class="nav-item ">
                            <a class="nav-link <?= $active ?>" href="index.php?com=redirect&act=man&type=redirect" title="redirect"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Redirect</p>
                            </a>
                        </li>
                    </ul>
                ...
                <?php if (isset($config['user']['active']) && $config['user']['active'] == true && !$func->check_permission()) { ?>
                    ...
                    <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            ?>
                                <li class="nav-item <?= $active ?> <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=user&act=permission_group" title="Nhóm quyền"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                        <p>Nhóm quyền</p>
                                    </a></li>
                            <?php } ?>
                            ...
                            $active = "";
                            if (isset($kiemtra) && $kiemtra == true) if ($func->check_access('user', 'capnhat', '', null, 'phrase-1')) $none = "d-none";
                            if (isset($config['user']['admin']) && $config['user']['admin'] == true) {
                            ?>
                                <li class="nav-item <?= $active ?> <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=user&act=admin_edit" title="Thông tin admin"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                        <p>Thông tin admin</p>
                                    </a></li>
                                <li class="nav-item <?= $active ?> <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=user&act=man_admin" title="Tài khoản admin"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                        <p>Tài khoản admin</p>
                                    </a></li>
                            <?php } ?>
                            <?php
                            $none = "";
                            $active = "";
                            if (isset($kiemtra) && $kiemtra == true) if ($func->check_access('thanhvien', 'capnhat', '', null, 'phrase-1')) $none = "d-none";
                            if (isset($config['user']['visitor']) && $config['user']['visitor'] == true) {
                                $active = "";
                                if ($com == 'user' && ($act == 'man_vip' || $act == 'add_vip' || $act == 'edit_vip')) $active = "active"; ?>
                                <li class="nav-item <?= $active ?> <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=user&act=man_vip" title="VIP"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                        <p>VIP</p>
                                    </a></li>
                            <?php } ?>
                            <?php
                            ...
                            if (isset($config['user']['visitor']) && $config['user']['visitor'] == true) {
                                ...
                                <li class="nav-item <?= $active ?> <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=user&act=man" title="Tài khoản khách"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                        <p>Tài khoản khách</p>
                                    </a></li>
                            <?php } ?>
                        </ul>
