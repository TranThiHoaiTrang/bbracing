<?php
    ...
    $thongbao_cohangNotify = $d->rawQuery("select id from #_contact where hienthi = 0 and type='thongbao_cohang' ");
    $dangkyNotify = $d->rawQuery("select id from #_newsletter where hienthi = 0 and type='comment' ");

    $countNotify += count($contactNotify) + count($dangkyNotify) + count($thongbao_cohangNotify);
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow">
                ...
                <a href="index.php?com=contact&act=man&type=thongbao_cohang" class="dropdown-item"><i class="fas fa-envelope mr-2"></i><span class="badge badge-danger mr-1"><?=count($thongbao_cohangNotify)?></span> Thông báo khi có hàng</a>
