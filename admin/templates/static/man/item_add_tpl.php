                    ...
                    <?php if (isset($flagGallery) && $flagGallery == true) { ?>
                        <div class="card card-primary card-outline text-sm">
                            <div class="card-header">
                                <h3 class="card-title">Danh sách <?= $config['static'][$type]['title_main'] ?></h3>
                                        ...
                                        <div class="jFiler-items my-jFiler-items jFiler-row">
                                            ...
                                            <ul class="jFiler-items-list jFiler-items-grid row scroll-bar">
                                                <?php foreach ($gallery as $g) { ?>
                                                    <?= $func->galleryFiler($g['stt'], $g['id'], $g['photo'], $g['tenvi'], 'static', 'col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6'); ?>
                                                <?php } ?>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <?php if (
                                ...
                                <div class="card card-primary card-outline card-outline-tabs">
                                    ...
                                    <div class="card-body card-article">
                                        ...
                                        <?php if (isset($config['static'][$type]['link_youtube']) && $config['static'][$type]['link_youtube'] == true) { ?>
                                            <div class="form-group">
                                                <label for="link_youtube">Link:</label>
                                                <input type="text" class="form-control for-seo" name="data[link_youtube]" id="link_youtube" placeholder="Link" value="<?= @$item['link_youtube'] ?>">
                                            </div>
                                        <?php } ?>
                                    </div>
                                </div>
