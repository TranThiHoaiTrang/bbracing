    ...
    <form method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <?php if (isset($config['photo']['man_photo'][$type]['huong_slide']) && $config['photo']['man_photo'][$type]['huong_slide'] == true) { ?>
                    <div class="form-group">
                        <label for="huong_slide">Hướng slide:</label>
                        <select class="form-control" name="data[huong_slide]" id="huong_slide">
                            <option value="0">Chọn hướng</option>
                            <option <?=(@$item['huong_slide']=='left')?"selected":""?> value="left">Left</option>
                            <option <?=(@$item['huong_slide']=='right')?"selected":""?> value="right">Right</option>
                            <option <?=(@$item['huong_slide']=='center')?"selected":""?> value="center">Center</option>
                        </select>
                    </div>
                <?php } ?>
