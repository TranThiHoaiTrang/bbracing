    ...
    <form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
			...
			<?php foreach($config['product'] as $key => $value) { ?>
			    <div class="card card-permission card-primary card-outline text-sm">
		            ...
		            <div class="card-body">
		            	...
		            	<?php } ?>
						<?php if(isset($value['doday']) && $value['doday'] == true) { ?>
		            		<div class="form-group row">
								<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-product-doday-<?=$key?>">Danh mục Vehicles:</label>
								<div class="col-md-7">
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-doday-view-<?=$key?>" value="product_man_doday_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_man_doday_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-doday-view-<?=$key?>" class="custom-control-label font-weight-normal">Xem danh sách</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-doday-add-<?=$key?>" value="product_add_doday_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_add_doday_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-doday-add-<?=$key?>" class="custom-control-label font-weight-normal">Thêm mới</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-doday-edit-<?=$key?>" value="product_edit_doday_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_edit_doday_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-doday-edit-<?=$key?>" class="custom-control-label font-weight-normal">Chỉnh sửa</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-doday-delete-<?=$key?>" value="product_delete_doday_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_delete_doday_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-doday-delete-<?=$key?>" class="custom-control-label font-weight-normal">Xóa</label>
				                    </div>
								</div>
							</div>
		            	<?php } ?>
						<?php if(isset($value['doday']) && $value['doday'] == true) { ?>
		            		<div class="form-group row">
								<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-product-doday-list-<?=$key?>">Danh mục Vehicles list:</label>
								<div class="col-md-7">
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-doday-list-view-<?=$key?>" value="product_man_doday_list_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_man_doday_list_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-doday-list-view-<?=$key?>" class="custom-control-label font-weight-normal">Xem danh sách</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-doday-list-add-<?=$key?>" value="product_add_doday_list_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_add_doday_list_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-doday-list-add-<?=$key?>" class="custom-control-label font-weight-normal">Thêm mới</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-doday-list-edit-<?=$key?>" value="product_edit_doday_list_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_edit_doday_list_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-doday-list-edit-<?=$key?>" class="custom-control-label font-weight-normal">Chỉnh sửa</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-doday-list-delete-<?=$key?>" value="product_delete_doday_list_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_delete_doday_list_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-doday-list-delete-<?=$key?>" class="custom-control-label font-weight-normal">Xóa</label>
				                    </div>
								</div>
							</div>
		            	<?php } ?>
						<?php if(isset($value['option']) && $value['option'] == true) { ?>
		            		<div class="form-group row">
								<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-product-option-<?=$key?>">Danh mục Option:</label>
								<div class="col-md-7">
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-option-view-<?=$key?>" value="product_man_option_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_man_option_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-option-view-<?=$key?>" class="custom-control-label font-weight-normal">Xem danh sách</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-option-add-<?=$key?>" value="product_add_option_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_add_option_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-option-add-<?=$key?>" class="custom-control-label font-weight-normal">Thêm mới</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-option-edit-<?=$key?>" value="product_edit_option_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_edit_option_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-option-edit-<?=$key?>" class="custom-control-label font-weight-normal">Chỉnh sửa</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-option-delete-<?=$key?>" value="product_delete_option_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_delete_option_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-doday-delete-<?=$key?>" class="custom-control-label font-weight-normal">Xóa</label>
				                    </div>
								</div>
							</div>
						...
						<?php if(isset($value['option']) && $value['option'] == true) { ?>
		            		<div class="form-group row">
								<label class="d-inline-block align-middle mb-2 mr-2 text-md col-md-3" for="quyen-product-option-list-<?=$key?>">Danh mục Option list:</label>
								<div class="col-md-7">
									<div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-option-list-view-<?=$key?>" value="product_man_option_list_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_man_option_list_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-option-list-view-<?=$key?>" class="custom-control-label font-weight-normal">Xem danh sách</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-option-list-add-<?=$key?>" value="product_add_option_list_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_add_option_list_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-option-list-add-<?=$key?>" class="custom-control-label font-weight-normal">Thêm mới</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 mr-4 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-option-list-edit-<?=$key?>" value="product_edit_option_list_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_edit_option_list_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-option-list-edit-<?=$key?>" class="custom-control-label font-weight-normal">Chỉnh sửa</label>
				                    </div>
				                    <div class="custom-control custom-checkbox d-inline-block align-middle mb-2 text-md">
				                        <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-product-option-list-delete-<?=$key?>" value="product_delete_option_list_<?=$key?>" <?=(isset($ds_quyen) && in_array('product_delete_option_list_'.$key, $ds_quyen))?'checked':'';?>>
				                        <label for="quyen-product-doday-list-delete-<?=$key?>" class="custom-control-label font-weight-normal">Xóa</label>
				                    </div>
								</div>
							</div>
		...
		<div class="card card-permission card-primary card-outline text-sm">
            ...
            <div class="card-body">
				<div class="form-group">
					<div class="custom-control custom-checkbox text-md">
		                <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-thanhvien" value="thanhvien_capnhat" <?=(isset($ds_quyen) && in_array('thanhvien_capnhat', $ds_quyen))?'checked':'';?>>
		                <label for="quyen-thanhvien" class="custom-control-label font-weight-normal">Chỉnh sửa thành viên</label>
		            </div>
				</div>
            </div>
        </div>
		<div class="card card-permission card-primary card-outline text-sm">
            <div class="card-header">
                <h3 class="card-title">Quản lý redirect link</h3>
                <div class="card-tools">
                	<button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                </div>
            </div>
            <div class="card-body">
				<div class="form-group">
					<div class="custom-control custom-checkbox text-md">
		                <input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-redirect" value="redirect" <?=(isset($ds_quyen) && in_array('redirect', $ds_quyen))?'checked':'';?>>
		                <label for="quyen-redirect" class="custom-control-label font-weight-normal">redirect</label>
		            </div>
				</div>
            </div>
        </div>
