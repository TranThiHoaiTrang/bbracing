		...
		<div class="card card-primary card-outline text-sm">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<?php } ?>
					<?php if(isset($config['setting']['diachien']) && $config['setting']['diachien'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="diachien">Địa chỉ en:</label>
							<input type="text" class="form-control" name="data[options][diachien]" id="diachien" placeholder="Địa chỉ en" value="<?=$options['diachien']?>">
						</div>
					<?php } ?>
					...
					<?php } ?>
					<?php if(isset($config['setting']['line']) && $config['setting']['line'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="line">line:</label>
							<input type="text" class="form-control" name="data[options][line]" id="line" placeholder="line" value="<?=$options['line']?>">
						</div>
					<?php } ?>
					<?php if(isset($config['setting']['wechat']) && $config['setting']['wechat'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="wechat">wechat:</label>
							<input type="text" class="form-control" name="data[options][wechat]" id="wechat" placeholder="wechat" value="<?=$options['wechat']?>">
						</div>
					<?php } ?>
					...
					<?php } ?>
					<?php if(isset($config['setting']['google_baohanh']) && $config['setting']['google_baohanh'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="google_baohanh">google_baohanh:</label>
							<input type="text" class="form-control" name="data[options][google_baohanh]" id="google_baohanh" placeholder="google_baohanh" value="<?=$options['google_baohanh']?>">
						</div>
					<?php } ?>
					...
					<?php } ?>
					<?php if(isset($config['setting']['link_youtube']) && $config['setting']['link_youtube'] == true) { ?>
						<div class="form-group col-md-12 col-sm-12">
							<label for="link_youtube">Link youtube:</label>
							<input type="text" class="form-control" name="data[options][link_youtube]" id="link_youtube" placeholder="Link youtube" value="<?=$options['link_youtube']?>">
						</div>
					<?php } ?>
					<?php if(isset($config['setting']['tigia']) && $config['setting']['tigia'] == true) { ?>
						<div class="form-group col-md-12 col-sm-12">
							<label for="tigia">Tỉ giá:</label>
							<input type="text" class="form-control format-price" name="data[options][tigia]" id="tigia" placeholder="Tỉ giá" value="<?=$options['tigia']?>">
						</div>
					<?php } ?>
				</div>
