<?php
	...
	function save_item(){
		...
		if($data){
			...
			if(isset($_POST['baohanh_group']) && ($_POST['baohanh_group'] != '')) $data['id_baohanh'] = implode(",", $_POST['baohanh_group']);
			else $data['id_baohanh'] = "";

			$data['ngaymuahang'] = strtotime ( $data['ngaymuahang'] );
			// $data['thoigianbaohanh'] = strtotime ( $data['thoigianbaohanh'] );
			$data['ngaybatdau'] = strtotime ( $data['ngaybatdau'] );
			$data['ngayketthuc'] = strtotime ( $data['ngayketthuc'] );
			$data['ngaysinh'] = strtotime ( $data['ngaysinh'] );
