<?php
    ...
    $config['photo']['photo_static'][$nametype]['thumb'] = '200x55x1';
    $config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';

    /* Logo */
    $nametype = "logo_mobile";
    $config['photo']['photo_static'][$nametype]['title_main'] = "Logo mobile";
    $config['photo']['photo_static'][$nametype]['images'] = true;
    $config['photo']['photo_static'][$nametype]['width'] = 200;
    $config['photo']['photo_static'][$nametype]['height'] = 55;
    $config['photo']['photo_static'][$nametype]['thumb'] = '200x55x1';
    ...
    $config['photo']['man_photo'][$nametype]['huong_slide'] = true;
    ...
    /* Slideshow */
    $nametype = "tracking";
    $config['photo']['man_photo'][$nametype]['title_main_photo'] = "Tracking";
    ...
    /* Slideshow */
    $nametype = "thanh_toan";
    $config['photo']['man_photo'][$nametype]['title_main_photo'] = "Thanh toán";
    $config['photo']['man_photo'][$nametype]['number_photo'] = 2;
    $config['photo']['man_photo'][$nametype]['images_photo'] = true;
    $config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
    $config['photo']['man_photo'][$nametype]['link_photo'] = true;
    ...
    $nametype = "background-banner";
    $config['photo']['photo_static'][$nametype]['title_main'] = "Backgroud banner";
    $config['photo']['photo_static'][$nametype]['images'] = true;
    $config['photo']['photo_static'][$nametype]['background'] = true;
    $config['photo']['photo_static'][$nametype]['width'] = 1366;
    $config['photo']['photo_static'][$nametype]['height'] = 350;
    ...
    $nametype = "background-footer";
    $config['photo']['photo_static'][$nametype]['title_main'] = "Backgroud Footer";
    $config['photo']['photo_static'][$nametype]['images'] = true;
    $config['photo']['photo_static'][$nametype]['background'] = true;
    $config['photo']['photo_static'][$nametype]['width'] = 1366;
    $config['photo']['photo_static'][$nametype]['height'] = 350;
    ...
    $nametype = "banner_sp_moi";
    $config['photo']['photo_static'][$nametype]['title_main'] = "Banner sản phẩm mới";
    $config['photo']['photo_static'][$nametype]['images'] = true;
    $config['photo']['photo_static'][$nametype]['background'] = true;
    $config['photo']['photo_static'][$nametype]['width'] = 1366;
    $config['photo']['photo_static'][$nametype]['height'] = 350;
    ...
    $nametype = "banner_sp_moi_mobile";
    $config['photo']['photo_static'][$nametype]['title_main'] = "Banner sản phẩm mới mobile";
    $config['photo']['photo_static'][$nametype]['images'] = true;
    $config['photo']['photo_static'][$nametype]['background'] = true;
    $config['photo']['photo_static'][$nametype]['width'] = 1366;
    $config['photo']['photo_static'][$nametype]['height'] = 350;
    ...
    $nametype = "banner_event";
    $config['photo']['photo_static'][$nametype]['title_main'] = "Banner event";
    $config['photo']['photo_static'][$nametype]['images'] = true;
    ...
    $config['photo']['photo_static'][$nametype]['width'] = 1600;
    $config['photo']['photo_static'][$nametype]['height'] = 437;
    ...
    $config['photo']['photo_static'][$nametype]['images'] = true;
    $config['photo']['photo_static'][$nametype]['video'] = false;
    $config['photo']['photo_static'][$nametype]['tieude'] = true;
    $config['photo']['photo_static'][$nametype]['mota'] = false;
    $config['photo']['photo_static'][$nametype]['noidung'] = false;
    $config['photo']['photo_static'][$nametype]['width'] = 1600;
    $config['photo']['photo_static'][$nametype]['height'] = 745;
    $config['photo']['photo_static'][$nametype]['thumb'] = '1600x745x1';
    $config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
    ...
    $config['photo']['photo_static'][$nametype]['height'] = 27;
    $config['photo']['photo_static'][$nametype]['thumb'] = '100x27x1';
    ...
    $config['photo']['photo_static'][$nametype]['height'] = 720;
    $config['photo']['photo_static'][$nametype]['thumb'] = '580x720x1';
    $config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
?>